...
namespace ProjectTile.UWP
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                if (rootFrame.Content == null)
                {
                    ...
                    // parameter
                    rootFrame.Navigate(typeof(Views.Pages.MainPageView), e.Arguments);
                }
        ...
        protected override void OnBackgroundActivated(BackgroundActivatedEventArgs e)
        {
            ...
            if (e.TaskInstance.TriggerDetails is AppServiceTriggerDetails)
            {
                var details = e.TaskInstance.TriggerDetails as AppServiceTriggerDetails;
                App.AppServiceConnection = details.AppServiceConnection;
                OnAppServiceReady(this);
            }
        }
        #endregion
        ...
        public static bool IsAppServiceReady;

        public static event EventHandler AppServiceReady;
        #endregion
    }
}
